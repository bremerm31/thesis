...
\node[text width=2.25 cm,align=left,below=4pt] at (1.3,5.0) {World Model};
...
\node[text width=2 cm,align=left,below=4pt] at (1.55,4.15) {Rank Model};
...
\node[text width=2 cm, align=left,below=4pt] at (1.7,3.3) {Tile Model};
\end{tikzpicture}
...
To accommodate both memory and load balance objectives, we implement the refinement procedure used in \cite{Karypis1998b}.
